...
const MusicPlaylists = require("../models/musicPlaylist").Playlist;
const MusicTrack = require("../models/musicPlaylist").MusicTrack;

const User = require("../models/user");
const createCustomMusicPlaylist = (req, res) => {
...
const getMusicPlaylistById = (req, res) => {
    MusicPlaylists.findOne({ _id: req.params.playlist }, (err, playlist) => {
        if (err) {
...
const getAllMusicPlaylists = (req, res) => {
    MusicPlaylists.find({ createdBy: req.params.userId }, (err, playlist) => {
        if (err) {
...
const updateCustomMusicPlaylist = (req, res) => {
...
const removeCustomMusicPlaylist = (req, res) => {
